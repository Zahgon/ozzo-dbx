...
func (b *SqliteBuilder) Select(cols ...string) *SelectQuery { _ = "STUB: not implemented"; return nil }
...
func (b *SqliteBuilder) Model(model interface{}) *ModelQuery { _ = "STUB: not implemented"; return nil }

// QuoteSimpleTableName quotes a simple table name.
// A simple table name does not contain any schema prefix.
func (b *SqliteBuilder) QuoteSimpleTableName(s string) string { _ = "STUB: not implemented"; return "" }
...
func (b *SqliteBuilder) DropIndex(table, name string) *Query { _ = "STUB: not implemented"; return nil }

// TruncateTable creates a Query that can be used to truncate a table.
func (b *SqliteBuilder) TruncateTable(table string) *Query { _ = "STUB: not implemented"; return nil }

// DropColumn creates a Query that can be used to drop a column from a table.
func (b *SqliteBuilder) DropColumn(table, col string) *Query { _ = "STUB: not implemented"; return nil }
